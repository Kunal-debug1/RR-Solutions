function redirectLegacyServiceUrls() {
  const legacyServices = Object.freeze({
    ecommerce: "ecommerce-solutions.html",
    software: "custom-software-development.html",
    ai: "ai-automation.html",
    marketing: "digital-marketing.html",
    support: "support-maintenance.html"
  });
  const legacyPage = window.location.pathname.endsWith("website-development.html");
